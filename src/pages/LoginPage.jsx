            ...
            <div className="w-full max-w-md animate-in">
                <div className="glass p-10 border-glow-blue relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center mb-10">
                        <h2 className="text-3xl font-bold logo mb-2">Login</h2>
                        <p className="text-gray-500 font-mono text-xs uppercase tracking-[0.2em]">Secure Access</p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-gray-500 text-sm font-light">
                        New entity? <Link to="/register" className="text-neon-purple hover:text-neon-pink transition hover:underline">Register Pattern</Link>
                    </p>
                </div>
                
                <p className="text-center mt-8 text-[10px] text-gray-600 font-mono uppercase tracking-[0.3em] opacity-50">
                    Encrypted Connection Active • Port 443
                </p>
            </div>
        </div>
    );
