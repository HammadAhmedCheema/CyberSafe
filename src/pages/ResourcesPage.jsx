                        ...
                        <h3 className="additional-title">Additional Online Resources</h3>
                         <div className="additional-grid">
                            {additional.map((item, index) => (
                                <div key={index} className="additional-card group cursor-default">
                                    <h4 className="additional-item-title group-hover:text-white transition-colors">{item.title}</h4>
                                    <p className="additional-item-text text-slate-400 group-hover:text-slate-300 transition-colors leading-relaxed font-light">{item.text}</p>
                                </div>
                            ))}
                        </div>
                    </div>
